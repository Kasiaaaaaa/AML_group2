...
class NoiseAugment:
    """This class is to drawn random SNR uniformly in [5, 20] dB,
        and then mix noise with the clean waveform before MFCCs. I kind of follow the 
        noise aug procedure they follow here https://arxiv.org/pdf/2205.13086 """
    def __init__(
        self,
        root_path: str,
